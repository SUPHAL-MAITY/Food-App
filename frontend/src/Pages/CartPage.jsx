...
{!auth.token ?
  <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
    ...
    <h1 className="mb-4 font-serif text-5xl tracking-tight font-extrabold lg:text-6xl text-primary-600 dark:text-primary-500">Please Login to Check the Cart Page</h1>

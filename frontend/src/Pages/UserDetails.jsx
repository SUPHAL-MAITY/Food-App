...
const handleDelete=async(id)=>{
  try {
    ...
    const {data}= await axios.delete(`${import.meta.env.VITE_API}/api/userdetails/delete/${id}`)
    console.log(data)
    if(data){
...
<div className=" ml-[400px]  ">
       <button  onClick={(e)=>handleDelete(id)} className='text-red-600'>Delete Account ? </button>
</div>
